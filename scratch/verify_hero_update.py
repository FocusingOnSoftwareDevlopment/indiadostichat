...
def verify_all():
    ...
    if 'class="hero-rotating-bg"' not in html or 'class="hero-location-sidebar"' not in html:
        print("ERROR: Rotating background markup or location sidebar missing in index.html")
        errors += 1
    else:
    ...
    with open(css_path, 'r', encoding='utf-8') as f:
        css = f.read()
    required_classes = [".hero-rotating-bg", ".hero-bg-layer", ".hero-bg-overlay", ".hero-location-sidebar", ".hero-location-text", "h1.hero-flag-heading"]
