...
def make_svg():
  ...
  <defs>
    ...
    <g id='elephant'>
      <!-- Body outline -->
      <path d='M 10,25 C 10,12 25,8 40,8 C 44,8 46,10 47,12 C 50,12 54,10 56,4 C 54,-2 48,0 48,4 C 48,7 50,15 48,18 C 46,20 44,20 42,21 C 42,24 42,27 42,30 L 42,48 L 36,48 L 36,34 C 30,36 26,36 20,34 L 20,48 L 14,48 L 14,28 C 12,28 10,27 10,25 Z' fill='none' stroke='currentColor' stroke-width='1.2' stroke-linecap='round' stroke-linejoin='round' />
      <!-- Tail -->
      <path d='M 10,24 C 8,28 8,36 8,40' fill='none' stroke='currentColor' stroke-width='0.8' />
      <!-- Ear -->
      <path d='M 35,11 C 31,13 29,19 31,23 C 33,25 36,23 35,11 Z' fill='none' stroke='currentColor' stroke-width='1' />
      <!-- Eye -->
      <circle cx='43' cy='12' r='1' fill='currentColor' />
      <!-- Tusk -->
      <path d='M 46,20 L 50,21 L 47,23 Z' fill='currentColor' />
      <!-- Saddle blanket -->
      <path d='M 18,10 L 32,10 C 32,22 18,22 18,10 Z' fill='none' stroke='currentColor' stroke-width='1' />
      <circle cx='21' cy='14' r='0.8' fill='currentColor' />
      <circle cx='25' cy='16' r='0.8' fill='currentColor' />
      <circle cx='29' cy='14' r='0.8' fill='currentColor' />
    </g>
  </defs>
...
print(f'background-image: url("{clean_encode_svg(svg, "#ffffff", 0.04)}");')
print("\nLight Mode background-image:")
print(f'background-image: url("{clean_encode_svg(svg, "#8c2d19", 0.05)}"), linear-gradient(180deg, #fff7e8 0%, #f8ead3 100%) !important;')
